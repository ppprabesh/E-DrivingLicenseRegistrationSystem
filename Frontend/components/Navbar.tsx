                        ...
                        <nav className="flex flex-col p-4 space-y-4">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent className="dropdown-content">
                                    <Link
                                        href="/license-types/category-a"
                                        className="w-full"
                                    >
                                        <DropdownMenuItem>
                                            Category A - Two Wheelers
                                        </DropdownMenuItem>
                                    </Link>
                                    <Link
                                        href="/license-types/category-b"
                                        className="w-full"
                                    >
                                        <DropdownMenuItem>
                                    ...
                                    <Link
                                        href="/license-types/category-k"
                                        className="w-full"
                                    >
                                        <DropdownMenuItem>
                                            Category K - Agricultural
                                        </DropdownMenuItem>
                                    </Link>
                                    <Link
                                    ...
                                    >
                                        <DropdownMenuItem>
                                            Category J - Special Equipment
                                        </DropdownMenuItem>
                                    </Link>
                                    <Link
                                        href="/license-types/category-i"
                                        className="w-full"
                                    >
                                        <DropdownMenuItem>
