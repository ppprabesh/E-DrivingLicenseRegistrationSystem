    ...
    const signUp = async (
        ...
        try {
            ...
            const { data: existingUser, error: checkError } = await supabase
                ...
                .select("id")
                .or(
                    `citizenship_number.eq.${citizenshipNumber},phone_number.eq.${phoneNumber},email.eq.${email}`
                )
                .maybeSingle();
            ...
            if (existingUser) {
                throw new Error(
                    "A user with this citizenship number, phone number, or email already exists"
                );
            }
