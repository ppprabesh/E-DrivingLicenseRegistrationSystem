      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <Link href="/bill-renewal">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white">Renew Now</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <Link href="/updates">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white">View Updates</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
